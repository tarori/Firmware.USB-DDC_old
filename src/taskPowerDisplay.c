...
static void vtaskPowerDisplay(void* pcParameters)
{
    ...
    while (1) {
        if (TMP_alarm) {
            ...
            if (tx_print == 0) {
                ...
                pow_avg_index++;
                if (pow_avg_index >= cdata.PEP_samples)
                    pow_avg_index = 0;
    ...
    //------------------------------
            ...
            if (!have_si570) {
                ...
                if (audio_sample_buffer_index >= bufsize)
                    audio_sample_buffer_index = 0;
                ...
                if (spk_sample_buffer_index >= bufsize)
                    spk_sample_buffer_index = 0;
